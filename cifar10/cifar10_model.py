...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb  1 11:00:28 2023
...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        x_r = torch.flatten(x, 1) # flatten all dimensions except batch
...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=10, width_mult=1.0, hs_dim = 100):
        ...
        self.proj_hs = nn.Linear(self.last_channel, hs_dim)
...
class HypersphericalProto(nn.Module):
    ...
    def forward(self, input):
        embeddings = self.model(input, embed = 1)
        dists = nn.CosineSimilarity(dim=-1)(
